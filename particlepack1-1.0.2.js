...
* <a href="https://github.com/gamelab/particle-pack-1-plugin/blob/master/README.md">README.</a>
* @module Kiwi
...
Kiwi.Plugins.ParticlePack1 = {
	...
	*/
	...
	/**
	* The minimum version of Kiwi.js required to run this plugin in
...
Kiwi.Plugins.ParticlePack1.Bam = function( state, x, y ) {
	...
	var bam = new Kiwi.GameObjects.StatelessParticles(
		state, state.textures.particlePack1SpriteSheet, 0, 0, this.bamConfig );
	var stars = new Kiwi.GameObjects.StatelessParticles(
		state, state.textures.particlePack1SpriteSheet, 0, 0, this.starsConfig );
	group.addChild( bam );
...
Kiwi.Plugins.ParticlePack1.Boom = function( state, x, y ) {
	...
	group.x = x;
	group.y = y;
	var boom = new Kiwi.GameObjects.StatelessParticles(
		state, state.textures.particlePack1SpriteSheet, 0, 0, this.boomConfig );
	var explosion = new Kiwi.GameObjects.StatelessParticles(
...
Kiwi.Plugins.ParticlePack1.Fireworks = function( state, x, y ) {
	...
	return new Kiwi.GameObjects.StatelessParticles(
		state, state.textures.particlePack1SpriteSheet16, x, y, this.config );
};
...
Kiwi.Plugins.ParticlePack1.Poof = function ( state, x, y ) {
	...
	group.x = x;
	group.y = y;
	var poof = new Kiwi.GameObjects.StatelessParticles(
		state, state.textures.particlePack1SpriteSheet, 0, 0,
		this.poofConfig );
	var smokepuffs = new Kiwi.GameObjects.StatelessParticles(
		state, state.textures.particlePack1SpriteSheet, 0, 0,
		this.smokepuffsConfig );
	group.addChild( poof );
...
Kiwi.Plugins.ParticlePack1.Zap = function( state, x, y ) {
	...
	group.x = x;
	group.y = y;
	var zap = new Kiwi.GameObjects.StatelessParticles(
		state, state.textures.particlePack1SpriteSheet, 0, 0,
		this.zapConfig );
	var glow = new Kiwi.GameObjects.StatelessParticles(
		state, state.textures.particlePack1SpriteSheet, 0, 0,
